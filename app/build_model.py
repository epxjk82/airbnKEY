...
from src.airbnKEY_model import AirbnKEY_Model
...
def prep_annual_data_for_model(excel_file):
    ...
    listing_data_raw_df = pd.read_excel(excel_file, sheetname='Listings')
...
if __name__ == '__main__':
    ...
    print "monthly_data_df.shape ", monthly_data_df.shape
    print "listing_data_df.shape ", listing_data_df.shape
    ...
    filename ='static/gdbr_model.pkl'
    filename_backup ='static/gdbr_model_{}.pkl'.format(datestring)
